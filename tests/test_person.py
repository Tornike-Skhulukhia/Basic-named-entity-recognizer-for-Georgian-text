...
def test_5():
    text = """  
       ავტორი:მარიამ იზორია.
       
       რესტორანი “ჩვენის” დამფუძნებელი გურამ ბაღდოშვილი bm.ge-სთან აღნიშნავს, რომ კოვიდრეგულაციების მუდმივმა 
       ცვლილებამ მომხარებელს ახალი ჩვევები გაუჩინა, მაგალითად ისინი საღამოს ცხრა საათზე
       უკვე რესტორნებში აღარ დადიან და სახლში ყოფნას ამჯობინებენ.
    """

    answer = ["გურამ ბაღდოშვილი", "მარიამ იზორია"]
