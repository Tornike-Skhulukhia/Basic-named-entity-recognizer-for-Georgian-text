            ...
            [
                {
                    "match_case": 1,
                    "person": "ნიკა მელია",
                    "quote": "ჩვენ ვიყავით ბრძოლაში და ვრჩებით ბრძოლაში იქამდე, ვიდრე არ იქნება "
                    "უზრუნველყოფილი მისი სიცოცხლე და ჯანმრთელობა, რაც მიმაჩნია, არის "
                    "თითოეული ჩვენი პარტიის წევრის, ამომრჩევლის, მხარდამჭერის მთავარი "
                    "ცენტრალური საკითხი",
                },
                {
                    "match_case": 1,
                    "person": "ნიკა მელია",
                    "quote": "სხვადასხვა ფორმისა და შინაარსის საპროტესტო აქტივობები გაიმართება "
                    "სხვადასხვა ქალაქში. 5 მარტს, 17:00 საათზე რუსთაველის გამზირზე "
                    "ველოდებით ქვეყნის მოსახლეობის იმ ნაწილს, რომელიც თვლის, რომ ეს "
                    "ისტორიული უსამართლობა უნდა დასრულდეს და ამ ბრძოლაში არიან",
                },
                {
                    "match_case": 3,
                    "person": "ნიკა მელია",
                    "quote": "მოგეხსენებათ, რომ სახალხო დამცველის მიერ შექმნილი კონსილიუმი, "
                    "ცენტრი „ემპათია“, უცხოელი ექიმები, მიხეილ სააკაშვილის პირადი ექიმი "
                    "ერთხმად აღნიშნავენ, რომ მიხეილ სააკაშვილის მძიმე ჯანმრთელობის "
                    "მდგომარეობა, რომელიც დღითიდღე მძიმდება და მძიმდება, არ "
                    "ექვემდებარება საქართველოში განკურნებას. აქედან გამომდინარე, "
                    "ერთადერთი გზა მიხეილ სააკაშვილის სიცოცხლის გადარჩენის არის შემდეგი "
                    "– მიხეილ სააკაშვილი იყოს გადაყვანილი ქვეყნის ფარგლებს გარეთ უცხოურ "
                    "კლინიკაში, შესაბამისი მკურნალობის მისაღებად. ძალიან დასანანია, რომ "
                    "ამ ჰუმანიტარული საკითხის გამო გვიწევს პოლიტიკური ბრძოლა. "
                    "ჰუმანიტარულია ის საკითხი, რომელიც ადამიანის, ქვეყნის მესამე "
                    "პრეზიდენტის, მიხეილ სააკაშვილის სიცოცხლეს ეხება",
                },
            ],
        ),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        #####
        (  # two quotes instead of one at start/end case
            """
             ""დაზვერვის მონაცემებით, რაც კი ფაშისტურ ოჯახობას გააჩნია 30 წუთში ყველაფერი კიევის თავზე იფრენს" - ინფორმაციას რადას სახელმწიფო დეპუტატი ირინა გერაშენკო ავრცელებს. "დაზვერვის მონაცემებით, 30 წუთში კიევის თავზე იფრენს ყველაფერი, რაც ფაშისტურ ოჯახს გააჩნია. თხოვნაა, ყველამ თავი შეაფარეთ თავშესაფრებს," - წერს ირინა გერაშენკო . ინფორმაციას უკრაინული მედია ავრცელებს. 
            """,
            [
                {
                    "person": "ირინა გერაშენკო",
                    "quote": "დაზვერვის მონაცემებით, 30 წუთში კიევის თავზე იფრენს ყველაფერი, რაც ფაშისტურ ოჯახს გააჩნია. თხოვნაა, ყველამ თავი შეაფარეთ თავშესაფრებს,",
                    "match_case": 1,
                }
            ],
        ),
        (  # longer name_surnames - 3 names with 1 surname case
            """
            „ხვალ მივიღებთ ზომების მეოთხე პაკეტს, რუსეთის იზოლაციის გაზრდისა და იმ რესურსების ამოწურვის მიზნით, რომლითაც ის აფინანსებს ამ ბარბაროსულ ომს. ამჟამინდელი კრიზისი უპრეცედენტოა; ისევე, როგორც მასზე მეგობრული და სწრაფი რეაგირება დემოკრატიული ქვეყნების მხრიდან. მე უკვე ვთქვი და გავიმეორებ: უკრაინა გაიმარჯვებს“, – განაცხადა ურსულა ფონ დერ ლაიენმა.
            """,
            [
                {
                    "person": "ურსულა ფონ დერ ლაიენი",
                    "quote": "ხვალ მივიღებთ ზომების მეოთხე პაკეტს, რუსეთის იზოლაციის გაზრდისა და იმ რესურსების ამოწურვის მიზნით, რომლითაც ის აფინანსებს ამ ბარბაროსულ ომს. ამჟამინდელი კრიზისი უპრეცედენტოა; ისევე, როგორც მასზე მეგობრული და სწრაფი რეაგირება დემოკრატიული ქვეყნების მხრიდან. მე უკვე ვთქვი და გავიმეორებ: უკრაინა გაიმარჯვებს",
                    "match_case": 1,
                }
            ],
        ),
        (  # longer name_surnames - 2 names with 1 surname case
            """
            „ხალხის კვებასთან დაკავშირებული მდგომარეობა იძაბება, რადგან სოფლის მეურნეობის სექტორმა ვერ შეასრულა მარცვლეულის წარმოების გეგმა, შარშან ტაიფუნისგან მიყენებული ზარალის გამო“, - აღნიშნა კიმ ჩენ ინმა.
            """,
            [
                {
                    "person": "კიმ ჩენ ინი",
                    "quote": "ხალხის კვებასთან დაკავშირებული მდგომარეობა იძაბება, რადგან სოფლის მეურნეობის სექტორმა ვერ შეასრულა მარცვლეულის წარმოების გეგმა, შარშან ტაიფუნისგან მიყენებული ზარალის გამო",
                    "match_case": 1,
                }
            ],
        ),
        (  # longer name_surnames - front(case 2) - 3 names with 1 surname case
            """
            ურსულა ფონ დერ ლაიენი: „სალამი ხალხნო!“.
            """,
            [
                {
                    "person": "ურსულა ფონ დერ ლაიენი",
        ...
        (  # longer name_surnames - front(case 2) - 2 names with 1 surname case
            """
            კიმ ჩენ ინი: „ხალხის კვებასთან დაკავშირებული მდგომარეობა იძაბება, რადგან სოფლის მეურნეობის სექტორმა ვერ შეასრულა მარცვლეულის წარმოების გეგმა, შარშან ტაიფუნისგან მიყენებული ზარალის გამო“.
            """,
            [
                {
                    "person": "კიმ ჩენ ინი",
        ...
        (  # longer name_surnames - front(case 3)
            """
            კიმ ჩენ ინი რაღაცას აკეთებს.
            "მე რაღაც გავაკეთე" - თქვა ინმა
            """,
            [
                {
                    "person": "კიმ ჩენ ინი",
                    "quote": "მე რაღაც გავაკეთე",
                    "match_case": 3,
                }
            ],
        ),
        (
            # name surnames close to each other
            """
            ლიონელ მესი. კილიან მბაპემ: "მე-4 გოლიც უნდა გამეტანა" 
            """,
            [
                {
                    "person": "კილიან მბაპე",
                    "quote": "მე-4 გოლიც უნდა გამეტანა",
                    "match_case": 2,
                }
            ],
        ),
...
def test_weird_cases(text, expected_result):
    assert get_quotes(text) == expected_result
